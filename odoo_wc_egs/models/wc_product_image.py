...
class WcProductImage(models.Model):
    ...
    wc_instance_id = fields.Many2one("wc.instance.egs", "Instance", readonly=True, compute="_set_instance", store=True,
                                     ondelete='cascade')
    image = fields.Binary("Image", required=True)
    wc_product_tmpl_id = fields.Many2one('wc.product.template.egs', string='WooCommerce Product')
