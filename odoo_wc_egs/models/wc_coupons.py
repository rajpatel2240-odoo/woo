...
class WcCoupons(models.Model):
    ...
    product_ids = fields.Many2many("wc.product.template.egs", 'wc_product_tmpl_product_rel', 'product_ids',
                                   'wc_product_ids', "Products")
    exclude_product_ids = fields.Many2many("wc.product.template.egs", 'wc_product_tmpl_exclude_product_rel',
                                           'exclude_product_ids', 'wc_product_ids', "Exclude Products")
    product_category_ids = fields.Many2many('wc.category.egs', 'wc_template_categ_incateg_rel',
                                            'product_category_ids', 'wc_categ_id', "Product Categories")
    excluded_product_category_ids = fields.Many2many('wc.category.egs', 'wc_template_categ_exclude_categ_rel',
        ...
        for wc_coupons in request_batches:
            ...
            for wc_coupon in wc_coupons:
                ...
                row_data = {'code': wc_coupon.code,
                            ...
                            'expiry_date' if not wc_instance.wc_version != 'v1' else 'date_expires': wc_coupon.expiry_date or '',
                ...
                for wc_coupon_response in wc_coupon_responses:
                    ...
                    wc_coupon and wc_coupon.write(
                        {"coupon_id": wc_coupon_response.get("id"), "used_by": wc_coupon_response.get("used_by"),
                         "date_created": wc_coupon_response.get("date_created"),
                         "date_modified": wc_coupon_response.get("date_modified"), "avail_in_wc": True})
        return True
